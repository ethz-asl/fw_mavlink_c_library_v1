...
static void mavlink_test_sens_4h_vector_probe(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_sens_4h_vector_probe_t packet_in = {
        93372036854775807ULL,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0
    };
    mavlink_sens_4h_vector_probe_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.timestamp = packet_in.timestamp;
        packet1.raw_pressure1 = packet_in.raw_pressure1;
        packet1.raw_pressure2 = packet_in.raw_pressure2;
        packet1.raw_pressure3 = packet_in.raw_pressure3;
        packet1.raw_pressure4 = packet_in.raw_pressure4;
        packet1.filtered_pressure1 = packet_in.filtered_pressure1;
        packet1.filtered_pressure2 = packet_in.filtered_pressure2;
        packet1.filtered_pressure3 = packet_in.filtered_pressure3;
        packet1.filtered_pressure4 = packet_in.filtered_pressure4;
        packet1.alpha = packet_in.alpha;
        packet1.beta = packet_in.beta;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sens_4h_vector_probe_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_sens_4h_vector_probe_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sens_4h_vector_probe_pack(system_id, component_id, &msg , packet1.timestamp , packet1.raw_pressure1 , packet1.raw_pressure2 , packet1.raw_pressure3 , packet1.raw_pressure4 , packet1.filtered_pressure1 , packet1.filtered_pressure2 , packet1.filtered_pressure3 , packet1.filtered_pressure4 , packet1.alpha , packet1.beta , packet1.u , packet1.pt );
    mavlink_msg_sens_4h_vector_probe_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sens_4h_vector_probe_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.raw_pressure1 , packet1.raw_pressure2 , packet1.raw_pressure3 , packet1.raw_pressure4 , packet1.filtered_pressure1 , packet1.filtered_pressure2 , packet1.filtered_pressure3 , packet1.filtered_pressure4 , packet1.alpha , packet1.beta , packet1.u , packet1.pt );
    mavlink_msg_sens_4h_vector_probe_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_sens_4h_vector_probe_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_sens_4h_vector_probe_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.raw_pressure1 , packet1.raw_pressure2 , packet1.raw_pressure3 , packet1.raw_pressure4 , packet1.filtered_pressure1 , packet1.filtered_pressure2 , packet1.filtered_pressure3 , packet1.filtered_pressure4 , packet1.alpha , packet1.beta , packet1.u , packet1.pt );
    mavlink_msg_sens_4h_vector_probe_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_v4hp_calib_reference(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_V4HP_CALIB_REFERENCE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_v4hp_calib_reference_t packet_in = {
        93372036854775807ULL,17651,17755
    };
    mavlink_v4hp_calib_reference_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.timestamp = packet_in.timestamp;
        packet1.alpha = packet_in.alpha;
        packet1.beta = packet_in.beta;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_V4HP_CALIB_REFERENCE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_V4HP_CALIB_REFERENCE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_v4hp_calib_reference_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_v4hp_calib_reference_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_v4hp_calib_reference_pack(system_id, component_id, &msg , packet1.timestamp , packet1.alpha , packet1.beta );
    mavlink_msg_v4hp_calib_reference_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_v4hp_calib_reference_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.timestamp , packet1.alpha , packet1.beta );
    mavlink_msg_v4hp_calib_reference_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_v4hp_calib_reference_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_v4hp_calib_reference_send(MAVLINK_COMM_1 , packet1.timestamp , packet1.alpha , packet1.beta );
    mavlink_msg_v4hp_calib_reference_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ASLUAV(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_sens_4h_vector_probe(system_id, component_id, last_msg);
    mavlink_test_v4hp_calib_reference(system_id, component_id, last_msg);
}
