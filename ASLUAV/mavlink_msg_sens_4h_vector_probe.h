...
#define MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE_LEN 40
#define MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE_MIN_LEN 40
#define MAVLINK_MSG_ID_214_LEN 40
#define MAVLINK_MSG_ID_214_MIN_LEN 40

#define MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE_CRC 156
#define MAVLINK_MSG_ID_214_CRC 156
...
#define MAVLINK_MESSAGE_INFO_SENS_4H_VECTOR_PROBE { \
    ...
    {  { "timestamp", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_sens_4h_vector_probe_t, timestamp) }, \
         ...
         { "alpha", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_sens_4h_vector_probe_t, alpha) }, \
         { "beta", NULL, MAVLINK_TYPE_FLOAT, 0, 28, offsetof(mavlink_sens_4h_vector_probe_t, beta) }, \
         { "u", NULL, MAVLINK_TYPE_FLOAT, 0, 32, offsetof(mavlink_sens_4h_vector_probe_t, u) }, \
         { "pt", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_sens_4h_vector_probe_t, pt) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SENS_4H_VECTOR_PROBE { \
...
static inline uint16_t mavlink_msg_sens_4h_vector_probe_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, float raw_pressure1, float raw_pressure2, float raw_pressure3, float raw_pressure4, float alpha, float beta, float u, float pt)
{
...
static inline void mavlink_msg_sens_4h_vector_probe_send(mavlink_channel_t chan, uint64_t timestamp, float raw_pressure1, float raw_pressure2, float raw_pressure3, float raw_pressure4, float alpha, float beta, float u, float pt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SENS_4H_VECTOR_PROBE_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static inline void mavlink_msg_sens_4h_vector_probe_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, float raw_pressure1, float raw_pressure2, float raw_pressure3, float raw_pressure4, float alpha, float beta, float u, float pt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
