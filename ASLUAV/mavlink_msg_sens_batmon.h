...
typedef struct __mavlink_sens_batmon_t {
 uint64_t batmon_timestamp; /*<  Battery monitor last timestamp */
 float temperature; /*< Battery pack temperature in [deg C]*/
 uint32_t safetystatus; /*< Battery monitor sensor safety status report in Hex*/
 uint32_t operationstatus; /*< Battery monitor sensor operation status report in Hex*/
 ...
 *
 * @param batmon_timestamp  Battery monitor last timestamp 
 ...
 * @param safetystatus Battery monitor sensor safety status report in Hex
 * @param operationstatus Battery monitor sensor operation status report in Hex
 ...
 *
 * @return  Battery monitor last timestamp 
 */
 ...
 *
 * @return Battery monitor sensor safety status report in Hex
 */
 ...
 *
 * @return Battery monitor sensor operation status report in Hex
 */
